...
ALTER TABLE LBA_Jugadores WITH NOCHECK ADD CONSTRAINT CK_EdadRequerida CHECK (((CAST(CURRENT_TIMESTAMP AS DATE)-FechaNac) - 1900) BETWEEN 15 AND 50) /*Conflicto de datos. Date es incompatible con smallint*/
...
--ALTER TABLE LBA_Partidos WITH NOCHECK ADD CONSTRAINT CK_Puntos_Local CHECK (Puntos_Local IS NULL)
